...
export default class VolumeTotal_JPY extends React.Component {
    constructor(props) {
        super(props)
        this.state = {
            nData: []
    ...
    componentDidMount(){
        axios
            .get("http://127.0.0.1:3000/api/all-jpy-volume")
            .then(response => {
    ...
    getAllCharts = () => {
        const charts = [
            {type: 'line', title: 'Bitcoin Volume in BTC/JPY Trading Market'}
        ];
