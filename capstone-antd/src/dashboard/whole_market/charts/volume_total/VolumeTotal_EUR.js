...
export default class VolumeTotal_EUR extends React.Component {
    constructor(props) {
        super(props)
        this.state = {
            nData: []
    ...
    componentDidMount(){
        axios
            .get("http://127.0.0.1:3000/api/all-eur-volume")
            .then(response => {
    ...
    getAllCharts = () => {
        const charts = [
            {type: 'line', title: 'Bitcoin Volume in BTC/EUR Trading Market'}
        ];
